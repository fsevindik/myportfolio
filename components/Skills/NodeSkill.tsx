...
function NodeSkill({ direcitonLeft }: Props) {
  return (
    <a target="blank" href="https://nodejs.org/en">
      <div className="group relative flex cursor-pointer">
        <motion.img
          ...
          src="https://img2.pngindir.com/20180425/jrw/kisspng-node-js-javascript-web-application-express-js-comp-5ae0f84e2a4242.1423638015246930701731.jpg"

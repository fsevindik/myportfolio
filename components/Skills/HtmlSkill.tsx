...
function HtmlSkill({ direcitonLeft }: Props) {
  return (
    <a target="blank" href="https://www.w3schools.com/">
      <div className="group relative flex cursor-pointer">
        <motion.img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTQKq8xoA5jigsncz7zE25Ixgulxy3lAxZhhDhRx6fzlJe5ad3auq_9e_RigUKW6hWZCc&usqp=CAU"
